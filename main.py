...
if __name__ == "__main__":
    ...
    argparser.add_argument("--kernel_size", type=int, required=False, default=10)
    ...
    if args.dataset == 'ph2':
        train_dataset = PH2Dataset('train', img_size=args.img_size, n_pos=args.num_pos_clicks, n_neg=args.num_neg_clicks, intensity=args.intensity, kernel_size=args.kernel_size)
        val_dataset = PH2Dataset('val', img_size=args.img_size, n_pos=args.num_pos_clicks, n_neg=args.num_neg_clicks, intensity=args.intensity, kernel_size=args.kernel_size)
        test_dataset = PH2Dataset('test', img_size=args.img_size, n_pos=args.num_pos_clicks, n_neg=args.num_neg_clicks, intensity=args.intensity, kernel_size=args.kernel_size)
